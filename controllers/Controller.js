...
module.exports =
    class Controller {
        constructor(HttpContext, repository = null) {
            ...
            this.querystring = this.HttpContext.path.querystring;
        }
        head() {
        ...
        get(id) {
            if (this.repository != null) {
                ...
                else if((this.querystring == undefined && id != undefined) && isNaN(id)) {
                    this.HttpContext.response.JSON(this.repository.getId());
                }
                else
